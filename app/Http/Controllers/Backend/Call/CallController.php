...
class CallController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->hasRole('administrator')) {
            ...
            $idCounter = Counter::orderBy('id')->get()[0]->id;
            ...
            $counter = Counter::where('id_user', Auth::User()->id)->orderBy('id')->pluck('name', 'id');

            $idCounter =  Counter::where('id_user', Auth::User()->id)->get()[0]->id;
    ...
    /**
     * Sent email to client, max 3 next client.
     *
     * @param Request $request
     * @return void
    ...
    {
        $getNextNumber = $this->getDataFromDB($request->deptId)
        ...
        if($getNextNumber > 0){
            ...
            foreach ($getNextNumber as $singleData)
            {
