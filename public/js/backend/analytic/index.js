    ...
    $.get(urlSummaryMonth, function(response) {
        ...
        new Chart(ctxSummaryMonth, {
            ...
            data: {
                ...
                datasets: dataGraphMonth(dataSummaryPendingMonth, dataSummaryDoneMonth, dataSummaryTotalMonth)
            },
    ...
    $.get(urlDetailMonth, function(response) {
        ...
        new Chart(ctxDetailMonth, {
            ...
            data: {
                ...
                datasets: dataGraphMonth(dataDetailPendingMonth, dataDetailDoneMonth, DataDetailTotalMonth)
            },
            options: option('Month')
        });
    });
    ...
    $.get(urlSummaryYear, function(response) {
        ...
        new Chart(ctxSummaryYear, {
            ...
            data: {
                ...
                datasets: dataGraphMonth(dataSummaryPendingYear, dataSummaryDoneYear, dataSummaryTotalYear)
            },
            options: option('Year')
        });
    });
    ...
    $.get(urlDetailYear, function(response) {
        ...
        new Chart(ctxDetailYear, {
            ...
            data: {
                ...
                datasets: dataGraphMonth(dataDetailPendingYear, dataDetailDoneYear, DataDetailTotalYear)
            },
            options: option('Year')
        });
    });
...
function dataGraphMonth(pending, done, total) {
    return [{
            label: 'Pending',
            data: pending,
            borderWidth: 1,
