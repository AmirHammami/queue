                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-content">
                            {{ Form::select('id_department', $department, 1, array('id' => 'id_department', 'class' => 'form-control', 'placeholder' => 'Please Choose Department', 'required')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-content">
                            {{ Form::select('id_counter', $counter, $id_counter, array('id' => 'id_counter', 'class' => 'form-control', 'placeholder' => 'Please Choose Counter', 'required')) }}
                        </div>
                    </div>
                </div>
