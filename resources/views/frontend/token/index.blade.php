                        ...
                        <form>
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-2 mb-md-0">
                                    {{ Form::select('id_branch', $branch, 3, array('id' => 'id_branch', 'class' => 'form-control form-control-lg', 'placeholder' => __("main.choose_branch_placeholder"), 'required')) }}
                                   <!-- <small class="form-text text-muted text-help-style">
                                        {{ __("main.choose_branch_help_block") }}
                                    </small>-->
                                </div>
                                <div class="col-12 col-md-12 mb-2 mb-md-0">
                                    {{ Form::select('id_department', $department ?? '', 1, array('id' => 'id_department', 'placeholder' => __("main.choose_department_placeholder"), 'class' => 'form-control form-control-lg', 'required')) }}
                                  <!--  <small class="form-text text-muted text-help-style">
                                ...
                                <div class="col-12 col-md-12 mb-2 mb-md-0 d-none">
                                ...
                                <h2 class="or-style d-none">{{ __("main.or_text") }}</h2>
                                @endif
                                <div class="col-12 col-md-12 mb-2 mb-md-0 d-none">
                                ...
                                <div class="col-12 col-md-12 mb-2 mb-md-0 d-none">
                                    {{ Form::input('name', '', '', array('id' => 'name', 'placeholder' => __("main.name_placeholder"), 'class' => 'form-control form-control-lg')) }}
                                    <small class="form-text text-muted text-help-style">
                                       <!-- {{ __("main.sms_help_block") }} -->
                                    </small>
                                </div>
                                <div class="col-12 col-md-12 mb-2 mb-md-0 d-none">
                                    {{ Form::input('mobile', '', '', array('id' => 'mobile', 'placeholder' => __("main.mobile_placeholder"), 'class' => 'form-control form-control-lg')) }}
                                    <small class="form-text text-muted text-help-style">
                                       <!-- {{ __("main.sms_help_block") }} -->
                                    </small>
                                </div>
